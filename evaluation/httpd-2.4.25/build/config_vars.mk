...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /root/eval/httpd-2.4.25/srclib/apr-util/libaprutil-1.la -lexpat /root/eval/httpd-2.4.25/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
HTTPD_VERSION = 2.4.25
HTTPD_MMN = 20120211
abs_srcdir = /root/eval/httpd-2.4.25
...
APR_INCLUDEDIR = /root/eval/httpd-2.4.25/srclib/apr/include
APR_VERSION = 1.6.5
APR_CONFIG = /root/eval/httpd-2.4.25/install/bin/apr-1-config
APU_BINDIR = /root/eval/httpd-2.4.25/install/bin
APU_INCLUDEDIR = /root/eval/httpd-2.4.25/srclib/apr-util/include
APU_VERSION = 1.6.1
