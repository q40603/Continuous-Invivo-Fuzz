...
#define DEFAULT_MYSQL_HOME "/root/eval/mysql-server-mysql-5.6.35/bld2/mysql"
#define SHAREDIR "/root/eval/mysql-server-mysql-5.6.35/bld2/mysql/share"
#define DEFAULT_BASEDIR "/root/eval/mysql-server-mysql-5.6.35/bld2/mysql"
#define MYSQL_DATADIR "/root/eval/mysql-server-mysql-5.6.35/bld2/data"
#define DEFAULT_CHARSET_HOME "/root/eval/mysql-server-mysql-5.6.35/bld2/mysql"
#define PLUGINDIR "/root/eval/mysql-server-mysql-5.6.35/bld2/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/root/eval/mysql-server-mysql-5.6.35/bld2/mysql/etc"
