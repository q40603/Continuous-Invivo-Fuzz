...
#define DEFAULT_MYSQL_HOME "/root/eval/mysql-server-mysql-5.6.35/bld/mysql"
#define SHAREDIR "/root/eval/mysql-server-mysql-5.6.35/bld/mysql/share"
#define DEFAULT_BASEDIR "/root/eval/mysql-server-mysql-5.6.35/bld/mysql"
#define MYSQL_DATADIR "/root/eval/mysql-server-mysql-5.6.35/bld/data"
#define DEFAULT_CHARSET_HOME "/root/eval/mysql-server-mysql-5.6.35/bld/mysql"
#define PLUGINDIR "/root/eval/mysql-server-mysql-5.6.35/bld/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/root/eval/mysql-server-mysql-5.6.35/bld/mysql/etc"
