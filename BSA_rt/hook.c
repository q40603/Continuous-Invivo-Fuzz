...
ssize_t BSA_hook_recvmsg(int sockfd, struct msghdr *msg, int flags){
    ...
    if (BSA_state == BSARun && ret > 0){
        BSA_log("setting invivo_edge %d to 1\n", _invivo_edge);
        *(u8*)(BSA_entry_value_map+_invivo_edge) = 1;
